...
import 'package:flutter_ig/repositories/notification/notification_repository.dart';
...
class NotificationsBloc extends Bloc<NotificationsEvent, NotificationsState> {
  ...
  StreamSubscription<List<Future<Notif?>>>? _notifSubscription;
  ...
  NotificationsBloc({
    ...
    _notifSubscription = _notificationRepository
      ...
      add(NotificationsUpdateNotifications(
        notifications: allNotifications as List<Notif>,
      ));
    });
  }
  ...
  Stream<NotificationsState> _mapNotificationsUpdateNotificationsToState(
    ...
    yield state.copyWith(
        notifications: event.notifications, status: NotificationsStatus.loaded);
  }
}
